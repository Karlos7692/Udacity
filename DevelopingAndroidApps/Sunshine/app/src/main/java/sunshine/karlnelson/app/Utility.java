...
public class Utility {
    ...
    public static @SunshineSyncAdapter.LOCATION_STATUS
    int getNetworkStatus(Context c) {
        return SunshineSyncAdapter.getLocationStatus(c);
    }

    public static int getLocationStatusMessage(Context c) {
        // There is a network connection
        @SunshineSyncAdapter.LOCATION_STATUS int status = SunshineSyncAdapter.getLocationStatus(c);
        switch (status) {
            case SunshineSyncAdapter.LOCATION_STATUS_SERVER_DOWN:
                return R.string.empty_forecast_list_server_down;
            case SunshineSyncAdapter.LOCATION_STATUS_SERVER_INVALID:
                return R.string.empty_forecast_list_server_error;
            case SunshineSyncAdapter.LOCATION_STATUS_INVALID:
                return R.string.empty_forecast_list_invalid_location;
            default:
                return R.string.empty_forecast_list_default;
        }
    }
