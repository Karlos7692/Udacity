    ...
    private void setPreferenceSummary(Preference preference, Object value) {
        ...
        if (preference instanceof ListPreference) {
            ...
            if (preference.getKey().equals(getString(R.string.pref_location_key))) {
                int status = Utility.getNetworkStatus(this);
                switch (status) {
                    case SunshineSyncAdapter.LOCATION_STATUS_OK:
                        preference.setSummary(stringValue);
                        break;
                    case SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN:
                        stringValue = String.format(getString(R.string.pref_status_unknown_location), stringValue);
                        preference.setSummary(stringValue);
                        break;
                    case SunshineSyncAdapter.LOCATION_STATUS_INVALID:
                        stringValue = String.format(getString(R.string.pref_status_invalid_location), stringValue);
                        preference.setSummary(stringValue);
                        break;
                    default:
                        preference.setSummary(stringValue);
